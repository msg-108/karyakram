...
urlpatterns = [
    ...
    path(
        "organizer/summary/",
        OrganizerDashboardSummaryView.as_view(),
        name="organizer-summary",
    ),
    # Organizer dashboard: event list for dashboard card
    path(
        "organizer/events/", OrganizerEventListView.as_view(), name="organizer-events"
    ),
    path(
